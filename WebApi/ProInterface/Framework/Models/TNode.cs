...
namespace ProInterface.Models
{
    public class TNode
    {
        ...
        public TNode()
        {
            ...
            AllRole = new Dictionary<int,string>();
            AllStatus = new Dictionary<int, string>();
        ...
        /// </summary>
        [Display(Name = "所有状态")]
        public Dictionary<int, string> AllStatus { get; set; }

        /// <summary>
        /// 所有角色
        /// </summary>
        [Display(Name = "所有角色")]
        public Dictionary<int, string> AllRole { get; set; }
