...
namespace ProServer
{
    ...
    {
        public static bool UserCheckFunctioAuthority(string loginKey, ref ErrorInfo err, MethodBase methodBase)
        {

            return true;
        }
        public static void UserWriteLog(string loginKey, MethodBase methodBase, StatusType.UserLogType userLogType)
        {
        ...
        /// <returns></returns>
        public static DateTime AnalysisRunDate(string runDataStr)
        {
